...
func main() {
	...
	// Metrics endpoint is enabled in 'config/operator/kustomization.yaml'. The Metrics options configure the server.
	// More info:
	...
	// - [METRICS-WITH-CERTS] at config/operator/kustomization.yaml to generate and use certificates
