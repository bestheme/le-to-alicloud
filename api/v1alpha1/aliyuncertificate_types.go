...
// AliyunCertificateSpec defines the desired state of AliyunCertificate.
type AliyunCertificateSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of AliyunCertificate. Edit aliyuncertificate_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// AliyunCertificateStatus defines the observed state of AliyunCertificate.
...
// AliyunCertificate is the Schema for the aliyuncertificates API.
