...
const namespace = "le-to-alicloud-system"

// serviceAccountName created for the project
const serviceAccountName = "le-to-alicloud-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "le-to-alicloud-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "le-to-alicloud-metrics-binding"
...
func serviceAccountToken() (string, error) {
	//nolint:gosec // G101 误报：这是 TokenRequest 的请求体模板，里面只有 apiVersion/kind，没有令牌
